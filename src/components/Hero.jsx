        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className={`space-y-8 transform transition-all duration-1000 ${
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#contact" className="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-600 to-violet-600 text-white rounded-xl font-semibold transition-all duration-300 hover:from-purple-500 hover:to-violet-500 hover:shadow-lg hover:shadow-purple-500/25 hover:scale-105">
                Get In Touch
                <ArrowRight className="ml-2 w-5 h-5 transition-transform group-hover:translate-x-1" />
              </a>
              <a href="#projects" className="inline-flex items-center px-8 py-4 border-2 border-purple-500/30 text-purple-300 rounded-xl font-semibold transition-all duration-300 hover:border-purple-400 hover:bg-purple-500/10 backdrop-blur-sm">
                View My Work
              </a>
            </div>
          ...
          <div className={`flex justify-center md:justify-end transform transition-all duration-1000 delay-200 ${
            ...
            <div className="relative">
              ...
              <div className="relative w-80 h-80 bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl shadow-2xl shadow-purple-500/10 overflow-hidden border border-gray-700/50 backdrop-blur-sm hover:scale-105 transition-transform duration-500 group">
                <img
                  src={heroImage} // ✅ from public/image/
