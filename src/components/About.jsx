...
export default function About() {
  ...
  return (
    <section 
      ref={sectionRef}
      className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center px-6 md:px-12 lg:px-24 relative overflow-hidden"
    >
      {/* Background Effects */}
      <div className="absolute inset-0">
        <div className="absolute top-32 left-32 w-96 h-96 bg-purple-500/8 rounded-full blur-3xl"></div>
        <div className="absolute bottom-32 right-32 w-80 h-80 bg-violet-500/8 rounded-full blur-3xl"></div>
        <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-fuchsia-500/6 rounded-full blur-3xl"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`space-y-8 transform transition-all duration-1000 ${
            ...
            <div className="space-y-4">
              <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-400 via-violet-400 to-fuchsia-400 bg-clip-text text-transparent">
                About Me
              </h2>
          ...
          <div className={`space-y-8 transform transition-all duration-1000 delay-200 ${
            ...
            <div className="space-y-4 text-center lg:text-left">
              ...
              <p className="text-lg text-gray-400">Technologies I know and actively work with:</p>
            </div>
